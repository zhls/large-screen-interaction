...
基于魔珐星云3D数字人技术，打造一个AI驱动的实时数据洞察平台。通过数字人配合大屏数据可视化，为管理者提供直观、智能的业务洞察。系统采用绿色科技风格设计，左侧为高大的数字人展示区，右侧为完整的数据可视化大屏。
...
| 功能 | 描述 |
|------|------|
| **AI数据生成** | 使用魔搭AI (DeepSeek-V3.2) 动态生成7个核心指标+地区数据+行业数据+竞争数据+风险数据 |
| **场景切换** | 5种预设场景（正常/促销/淡季/异常/自定义） |
| **智能对话** | AI助手基于当前数据回答业务问题 |
| **语音播报** | 数字人自动/手动播报数据摘要，采用专业自然的播报风格 |
| **异常预警** | 智能检测并预警数据异常 |
| **多视图切换** | 总览/地区/行业/竞争/风险5种视图 |
...
- **流式响应**：对话采用SSE流式传输
- **大屏适配**：自动缩放适配不同屏幕尺寸
- **绿色科技风格**：emerald-teal渐变主题，现代科技感UI
- **状态管理**：Zustand轻量级状态管理
...
- 设计尺寸：1920x1080
- 使用scale缩放适配
- 数字人固定在屏幕左侧，高度占90vh，宽度20vw
- 主内容区显示在右侧，响应式布局

---

*文档版本: v1.3 | 最后更新: 2026-01-09*
